package practicas_bases;

import java.sql.*;
import java.util.Scanner;

public class Practicas_bases {
        ...
        try {
            ...
            while (continuar) {
                ...
                switch (opcionPrincipal) {
                    case 1:
                        menuAgregar(conn, scanner);
                        break;

                    case 2:
                        menuModificar(conn, scanner);
                        break;

                    case 3:
                        menuEliminar(conn, scanner);
                        break;

                    case 4:
                        menuConsultar(stmt, scanner);
                        break;
    ...
    static void menuAgregar(Connection conn, Scanner scanner) throws SQLException {
        System.out.println("\n--- Agregar ---");
    ...
    static void menuModificar(Connection conn, Scanner scanner) throws SQLException {
        System.out.println("\n--- Modificar ---");
        System.out.println("1. Diseñador");
        System.out.println("2. Marca");
        System.out.println("3. Auto");
    ...
    static void menuEliminar(Connection conn, Scanner scanner) throws SQLException {
        System.out.println("\n--- Eliminar ---");
        System.out.println("1. Diseñador");
        System.out.println("2. Marca");
        System.out.println("3. Auto");
    ...
    static void menuConsultar(Statement stmt, Scanner scanner) throws SQLException {
        System.out.println("\n--- Consultar ---");
